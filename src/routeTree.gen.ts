...
import { Route as AppAdminProfilesIndexImport } from './routes/_app.admin.profiles.index'
import { Route as AppAlbumsAlbumIDPhotoIDImport } from './routes/_app.albums.$albumID.$photoID'
import { Route as AppAdminProfilesProfileIDImport } from './routes/_app.admin.profiles.$profileID'
...
const AuthAdminPermissionsLazyImport = createFileRoute(
  '/_auth/admin/permissions',
)()
const AuthAdminLoginLazyImport = createFileRoute('/_auth/admin/login')()
...
const AuthAdminPermissionsLazyRoute = AuthAdminPermissionsLazyImport.update({
  path: '/admin/permissions',
  getParentRoute: () => AuthRoute,
} as any).lazy(() =>
  import('./routes/_auth.admin.permissions.lazy').then((d) => d.Route),
)

const AuthAdminLoginLazyRoute = AuthAdminLoginLazyImport.update({
  path: '/admin/login',
  getParentRoute: () => AuthRoute,
} as any).lazy(() =>
  import('./routes/_auth.admin.login.lazy').then((d) => d.Route),
)
...
const AppAdminProfilesIndexRoute = AppAdminProfilesIndexImport.update({
  path: '/admin/profiles/',
  getParentRoute: () => AppRoute,
} as any)
...
const AppAdminProfilesProfileIDRoute = AppAdminProfilesProfileIDImport.update({
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_auth/admin/login': {
      ...
      preLoaderRoute: typeof AuthAdminLoginLazyImport
      parentRoute: typeof AuthImport
    }
    '/_auth/admin/permissions': {
      ...
      preLoaderRoute: typeof AuthAdminPermissionsLazyImport
      parentRoute: typeof AuthImport
    }
    '/_app/albums/': {
      id: '/_app/albums/'
    ...
    '/_app/admin/profiles/$profileID': {
      id: '/_app/admin/profiles/$profileID'
      path: '/admin/profiles/$profileID'
      fullPath: '/admin/profiles/$profileID'
      preLoaderRoute: typeof AppAdminProfilesProfileIDImport
      parentRoute: typeof AppImport
    }
    ...
    '/_app/admin/profiles/': {
      id: '/_app/admin/profiles/'
      path: '/admin/profiles'
      fullPath: '/admin/profiles'
      preLoaderRoute: typeof AppAdminProfilesIndexImport
      parentRoute: typeof AppImport
    }
  }
}
...
export const routeTree = rootRoute.addChildren({
  ...
  AppRoute: AppRoute.addChildren({
    ...
    AppAlbumsIndexRoute,
    AppAdminProfilesProfileIDRoute,
    AppAlbumsEditAlbumIDLazyRoute,
    AppAdminProfilesIndexRoute,
  }),
  AuthRoute: AuthRoute.addChildren({
    ...
    AuthAdminLoginLazyRoute,
    AuthAdminPermissionsLazyRoute,
  }),
  PasswordRoute,
})
